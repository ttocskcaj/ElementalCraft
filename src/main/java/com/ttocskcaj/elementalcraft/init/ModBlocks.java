...
public class ModBlocks {
    ...
    public static final BlockAquamarineOre AQUAMARINE_ORE = new BlockAquamarineOre();
    public static final BlockAzuriteOre AZURITE_ORE = new BlockAzuriteOre();
    public static final BlockBerylOre BERYL_ORE = new BlockBerylOre();
    public static final BlockBloodstoneOre BLOODSTONE_ORE = new BlockBloodstoneOre();
    public static final BlockCitrineOre CITRINE_ORE = new BlockCitrineOre();
    ...
    public static final BlockFluoriteOre FLUORITE_ORE = new BlockFluoriteOre();
    public static final BlockGarnetOre GARNET_ORE = new BlockGarnetOre();
    public static final BlockJadeOre JADE_ORE = new BlockJadeOre();
    ...
    public static final BlockOnyxOre ONYX_ORE = new BlockOnyxOre();
